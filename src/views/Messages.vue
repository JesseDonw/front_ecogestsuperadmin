...
const fetchClients = async () => {
  try {
    const response = await axios.get('https://ecogest1-69586dbc1b71.herokuapp.com/api/clients');
...
const fetchMessages = async () => {
  ...
  try {
    const response = await axios.get('https://ecogest1-69586dbc1b71.herokuapp.com/api/fetch-messages', {
      params: {
...
const sendMessage = async () => {
  ...
  try {
    const response = await axios.post('https://ecogest1-69586dbc1b71.herokuapp.com/api/send-message', {
